...
<title>StudentsBase - Create a Team Request</title>
...
<br><br><br>
<h1 style = "text-align:center;color:black">Create a team request</h1>

    
<div align="center">
  <form action="team_create.jsp?counter=<%=counter%>&subject=<%=subject%>" method="post">
...
status = "requested " + status + " teammates";
